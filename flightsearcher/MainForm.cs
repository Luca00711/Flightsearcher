...
namespace Flightsearcher
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            Icon = Icon.FromResource("Flightsearcher.logox512.ico");
        ...
        public StackLayout StackContent()
        {
            ...
            button.Click += async (s, e) =>
            {
                ...
                List<Flight> test = await APIRequest.Request(
                    $"https://data-cloud.flightradar24.com/zones/fcgi/feed.js/?airline={selectedAirline.ICAO}&type=A320",
            ...
            grid.Columns.Add(new GridColumn
                {DataCell = new TextBoxCell("fnac"), HeaderText = "Flight number and Callsign"});
            ...
            grid.Columns.Add(new GridColumn
                {DataCell = new TextBoxCell("flightduration"), HeaderText = "Flight Duration"});
            grid.CellClick += (s, e) =>
            {
                ...
                route.Click += async (sender, a) =>
                {
                    ...
                    layout.Items.Add(new Label
                        {Text = flight.departure, TextAlignment = TextAlignment.Center, Width = dialog.Width});
                    layout.Items.Add(new Label
                        {Text = flight.arrival, TextAlignment = TextAlignment.Center, Width = dialog.Width});
                ...
                livery.Click += async (sender, a) =>
                {
                    ...
                    StackLayout layout = new StackLayout();
                    layout.Items.Add(
                        new ImageView {Image = await Utils.Utils.GetPhoto(flight?.registration.ToString())});
                    dialog.Content = layout;
